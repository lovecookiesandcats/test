    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                container.append(btnFirst).append(btnPrev).append(list).append(btnNext).append($('<div/>'));
                ...
                function showRequiredButtons() {
                    if (totalpages > settings.length) {
                        ...
                        if (!settings.controlsalways) {
                            ...
                            btnPrev.css('display', 'none');
                            btnNext.css('display', 'none');
                            btnLast.css('disabled', 'none');
                        }
                        else {
                            btnFirst.css('display', '').addClass('display');
                            btnPrev.css('display', '').addClass('display');
                            btnNext.css('display', '').addClass('display');
                            btnLast.css('disabled', '').addClass('disabled');
                        }
                    }
                }
